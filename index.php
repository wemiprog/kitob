...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/css/main.css?19-06-27v1">
...
<body>
    <nav class="navbar navbar-expand-sm navbar-light sticky-top" style="background-color: #e5f2e6">
        ...
        <img id="logo" height="35px" src="/img/logo.png" alt="logo" style="
            padding-left: 10px;
            margin-top: 2px;
        ">
        <form class="form-inline my-2 my-lg-0" autocomplete="off">
            <input id="reference" class="form-control rounded-sm mr-sm-2 ml-2 ml-sm-3" type="search"
                placeholder="Интихоб" autocomplete="off">
    ...
    <div class="info book-load">
        <img src="/img/loading-ball.gif" alt='Мо Китоби интихобшударо меорем ...'>
    </div>
                    ...
                    <div class="row trans-select">
                        <div class="input-group mb-3">
                            <select tr="1" class="custom-select" id="trans-select1">
                                <option selected>КМН</option>
                            </select>
                            <select tr="2" class="custom-select" id="trans-select2">
                                <option selected>Ҳеҷ</option>
                            </select>
                        </div>
                    </div>
    ...
    <script src="/js/main.js?19-06-27v1"></script>
