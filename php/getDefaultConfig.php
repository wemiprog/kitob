...
if(isset($script)) {
    ...
    $vars = setVar($vars, "allowedChars", "ёйқукенгшҳзхъӯғэждлорпавҷфячсмитӣбюЁҒӮЪХЗҲШГНЕКУҚЙФҶВАПРОЛДЖЭЮБӢТИМСЧЯQWERTZUIOPASDFGHJKLYXCVBNMqwertzuioplkjhgfdsayxcvbnmÄÖÜäöüéàèîÉÀÈÎß:,.-1234567890 ");
...
setVar("allowedChars", 'ёйқукенгшҳзхъӯғэждлорпавҷфячсмитӣбюЁҒӮЪХЗҲШГНЕКУҚЙФҶВАПРОЛДЖЭЮБӢТИМСЧЯQWERTZUIOPASDFGHJKLYXCVBNMqwertzuiopasdfghjklyxcvbnmäöüÄÖÜéàèîÉÀÈÎß:,.\\-1234567890\/ ');
setVar("allowedTrans", /^([ёйқукенгшҳзхъӯғэждлорпавҷфячсмитӣбюЁҒӮЪХЗҲШГНЕКУҚЙФҶВАПРОЛДЖЭЮБӢТИМСЧЯQWERTZUIOPASDFGHJKLYXCVBNMqwertzuiopasdfghjklyxcvbnmäöüÄÖÜéàèîÉÀÈÎß1234567890]{3,4})\//);
setVar("allowedBook", /([A-Za-zÄÖÜäöü\u0400-\u0527]+)((( ?)([A-Za-zÄÖÜäöü\u0400-\u0527]+))?)/);
